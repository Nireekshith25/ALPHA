...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO health_records (student_id, checkup_date, height, weight, immunization_status, health_status, tests_conducted, notes) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    if ($stmt === false) {
        die("Prepare failed: " . $conn->error);
    }
    $stmt->bind_param("isssssss", $student_id, $checkup_date, $height, $weight, $immunization_status, $health_status, $tests_conducted, $notes);

    if ($stmt->execute()) {
        $message = "Health record updated successfully.";
    } else {
        $message = "Error updating health record: " . $stmt->error;
    }
...
<head>
    ...
    <title>Update Child Health Records</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h1>Update Child Health Records</h1>
    ...
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="tests_conducted" name="tests_conducted" rows="4" required></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="back-link">
            <a href="stored_health_records.php">View All Health Records</a>
        </div>
    </div>
</body>
</html>
